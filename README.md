...
```bash
ohpm install @kaworunagisa_hhl/page-header
```
...
```ts
import { SwiftUIPageHeader } from '@kaworunagisa_hhl/page-header'
import { SwiftUIHeaderStyle, SwiftUITone } from '@kaworunagisa_hhl/theme'
